...
<div class="ui text container">
    ...
    <div class="produk-dibeli">
        ...
        <table class="ui unstackable table">
            <thead>
                <tr>
                    <th style="width:55%"><?php _e('Pesanan anda', 'sejoli'); ?></th>
                    <th style="width:45%"><?php _e('Biaya', 'sejoli'); ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <th colspan="2">
                        ...
                        if ( $enable_quantity ) :
                            ...
                            <div class="ui labeled input" style="width: 100%;">
                                ...
                                <input type="hidden" class="qty-new" name="qty" id="qty" value="1" placeholder="<?php _e('Qty', 'sejoli'); ?>">
    ...
    <div class="bump-produk">
        <h3 class="bump-produk-title"><?php echo __('Yuk, tambahkan penawaran spesial dari kami:', 'sejoli'); ?></h3>
        <table class="ui unstackable table">
            <tbody>
                <tr>
                    <td>
                    ...
                    <div class="twelve wide column">
                        ...
                        {{if subscription}}
                            {{if subscription.duration}}
                                <?php _e('Durasi', 'sejoli'); ?>: {{:subscription.duration.string}}<br><br>
                            {{/if}}
                        {{/if}}
