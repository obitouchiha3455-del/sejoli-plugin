...
<div class="ui text container">
    <div class="grid-container grid-2">
       <div class="grid-item">
            ...
            <div class="metode-pembayaran">
                ...
                <div id="metodeTerpilih" class="metode-terpilih">
                    ...
                    <a id="ubahMetode" class="ubah-metode"><?php esc_html_e('UBAH METODE PEMBAYARAN', 'sejoli'); ?> <i class="angle right icon"></i></a>
                </div>
            </div>
            <?php endif; ?>
       </div>
       <div class="grid-item sticky-sidebar">
            ...
            <?php if(wp_is_mobile()): ?>
            <div class="metode-pembayaran" style="margin-bottom:2em;">
                <a id="pilihMetode" class="toggle-metode"><?php esc_html_e('PILIH METODE PEMBAYARAN', 'sejoli'); ?> <i class="angle down icon"></i></a>
            ...
            <td>
                <div class="ui stackable grid">
                    ...
                    <div class="twelve wide column">
                        ...
                        <h3 id="bump-total-holder-{{:product.ID}}" style="color: #1167af; margin: 0 0 1em 0;">+ <span class="bump-total-holder-{{:product.ID}}">{{:price}}</span></h3>
