        ...
        <div class="grid-container grid-2">
           <div class="grid-item">
                ...
                <div class="tujuan-pengiriman">
                    ...
                    <div class="ui form">
                        <div class="field">
                            <label><?php _e('Nama Penerima', 'sejoli'); ?></label>
                        ...
                        <div class="field">
                            ...
                            <label><?php _e('Alamat Penerima*', 'sejoli'); ?></label>
                        ...
                        <div class="field">
                            <label><?php _e('Pilih Kecamatan Pengiriman*', 'sejoli'); ?></label>
                        ...
                        <div class="field">
                            <label><?php _e('Kode POS*', 'sejoli'); ?></label>
                            <input type="text" name="kode_pos" id="kode_pos" placeholder="Kode pos"> 
                        </div>
                        <?php endif; ?>
                        <div class="field">
                            <label><?php _e('Nomor Telepon*', 'sejoli'); ?></label>
           ...
           <div class="grid-item sticky-sidebar">
                ...
                <?php if(wp_is_mobile()): ?>
                <div class="metode-pembayaran" style="margin-bottom:1em;">
                    <h2><?php _e('Pilih Metode Pembayaran', 'sejoli'); ?></h2>
                    <div class="ui doubling data-holder">
                        <div class="eight wide column">
                            <div class="ui placeholder">
...
<script id="metode-pengiriman-template" type="text/x-jsrender">
    {{if shipping_methods.length > 0 }}
        <div class="ui form">
            <div class="field">
                <label><?php _e('Metode Pengiriman', 'sejoli'); ?></label>
