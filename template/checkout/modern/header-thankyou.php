...
<head>
    ...
    $attachment_id = intval(sejolisa_carbon_get_post_meta($order['product_id'],'desain_bg_image'));
    ...
    $desain_bg_color = sejolisa_carbon_get_post_meta( $order['product_id'],'desain_bg_color' );
    ...
    $desain_bg_repeat = sejolisa_carbon_get_post_meta( $order['product_id'],'desain_bg_repeat' );
    ...
    $desain_bg_size = sejolisa_carbon_get_post_meta( $order['product_id'],'desain_bg_size' );
    ...
    $desain_bg_position = sejolisa_carbon_get_post_meta( $order['product_id'],'desain_bg_position' );
