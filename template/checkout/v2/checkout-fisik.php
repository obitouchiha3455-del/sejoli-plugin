...
<div class="ui text container">
    <form id='sejoli-checkout-fisik' class="checkout-fisik" method="POST" action=''>
        ...
        <div class="detail-pesanan">
            <h3 style="margin-bottom: 10px;"><?php _e('Detail Pesanan', 'sejoli'); ?></h3>
        ...
        <div class="tujuan-pengiriman">
            <h3 style="margin-bottom: 10px;"><?php _e('Tujuan Pengiriman', 'sejoli'); ?></h3>
            <div class="ui form">
                <div class="field">
        ...
        ?>
            <div class="metode-pengiriman">
                <h3 style="margin-bottom: 10px;"><?php _e('Biaya Pengiriman', 'sejoli'); ?></h3>
                <div class="ui form">
                    <div class="field">
            ...
            <?php else : ?>
            <div class="metode-pengiriman">
                <h3 style="margin-bottom: 10px;"><?php _e('Pilih Metode Pengiriman', 'sejoli'); ?></h3>
                <div class="data-holder">
        ...
        <div class="element-blockable">
            ...
            <div class="rincian-pesanan">
                <h3 style="margin-bottom: 0px;"><?php _e('Rincian Pesanan', 'sejoli'); ?></h3>
                ...
                <div class="ui stackable grid">
                    ...
                    <div class="eight wide column">
                        <div id='sejoli-total-bayar' class="total-bayar">
                            ...
                            <div class="total-holder"><span class="price"><?php _e('Rp 0', 'sejoli'); ?></span></div>  
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="eight wide column">
