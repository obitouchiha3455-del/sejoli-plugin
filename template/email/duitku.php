...
<?php printf(__('%s bisa melanjutkan pembayaran melalui link dibawah ini', 'sejoli'), $user_info->display_name);?>
  ...
  <tr>
    <td>
      <div style='text-align:center;'>
        ...
        <![endif]-->
        <a href='<?php echo $payment_link; ?>' target="_blank" style="background-color:#EB7035;border:1px solid #EB7035;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:44px;text-align:center;text-decoration:none;width:80%;padding:12px 20px;-webkit-text-size-adjust:none;mso-hide:all;"><?php _e('Selesaikan pembayaran', 'sejoli'); ?></a>
        <br/>
      </div>
    </td>
  </tr>
